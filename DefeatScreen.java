...
public class DefeatScreen implements Screen {
    ...
    public void draw(Graphics g) {
        ...
        g.drawString("YOU LOSE!", GameConstants.WINDOW_WIDTH / 2 - 100, GameConstants.WINDOW_HEIGHT / 2);
        g.setFont(new Font("Arial", Font.PLAIN, 24));
        g.drawString("Press ENTER to return to menu", GameConstants.WINDOW_WIDTH / 2 - 150, GameConstants.WINDOW_HEIGHT / 2 + 50);
        g.drawString("Press ESC to exit", GameConstants.WINDOW_WIDTH / 2 - 100, GameConstants.WINDOW_HEIGHT / 2 + 80);
    }
